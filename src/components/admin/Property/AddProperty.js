...
const AddProperty = () => {
    ...
    const { property_title, property_location, property_availability, property_price, property_desc, property_image, listing_type, categories, users, category, error, success, formData } = values
                    ...
                    <div className="col-md-6">
                        <main className="form-signin">
                            <form>
                                ...
                                <div className="form-floating mb-3">
                                    <select className="form-control" onChange={handleChange('category')} id="category" >
                                        <option></option>
