...
const Consult = () => {
    ...
    return (
        <>
            <Nav />
            <div className='text-center h4 text-success'>Requested for Consultation Successfully. You will be notified about your consultation arrangements soon. Meanwhile you can view other listings.</div>
