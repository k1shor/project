...
const Rent = () => {
    ...
    return <div>
        ...
        <h3 className='text-primary text-decoration-underline custom-cursor mb-5'>Properties for Rent</h3>

            <div class="row row-cols-1 row-cols-md-4 g-4">
                {listingsByPostdate.filter((item) => item.listing_type === "RENT").map((listing, i) => (
                    <div class="col">
